...
module.exports = {
  ...
  addMaterial: function (res, modelName) {
    db.sequelize.query(
      `INSERT INTO ${modelName}(material) VALUES ("This is some text")`
    );

    db.sequelize.query(
      `INSERT INTO ${modelName}(material) VALUES ("This is some other text")`
    );
    res.sendStatus(200);
  },
};
